...
# Строка «Редакция · опубликовано · обновлено» (fix_geo2026) — метаданные
# страницы, а не её содержимое. Без этого исключения строка кормит сама себя:
# коммит, который её вписал, делает страницу «обновлённой», следующая сборка
# пишет новую дату «обновлено», и так на всех 200 страницах разом.
BOILERPLATE_BLOCKS = (('section', 'class="cta"'), ('div', 'class="fab"'),
                      ('p', 'class="small muted meta-row"'))
