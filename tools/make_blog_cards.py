...
CARDS = {
    ...
    "montazh-ktp-kranom": ("Кран для монтажа КТП: какой нужен по весу", "ТЕХНИКА"),
    "kran-dlya-ustanovki-gazgoldera": ("Манипулятор для установки газгольдера: какой нужен", "ТЕХНИКА"),
    ...
    "kran-dlya-montazha-angara": ("Кран для монтажа ангара: какой тоннаж нужен под фермы", "ТЕХНИКА"),
    "kran-dlya-montazha-kns": ("Кран для монтажа КНС: какая техника нужна", "ТЕХНИКА"),
    "kran-dlya-montazha-itp": ("Манипулятор или кран для монтажа теплового пункта", "ТЕХНИКА"),
    "kran-dlya-montazha-bashni-rozhnovskogo": ("Кран для монтажа башни Рожновского: вылет важнее тоннажа", "ТЕХНИКА"),
