...
# MANIP НЕ обновлён на 03.09.2026: в прайсе Аркона есть только класс 7 т
# (25 600 ₽/смена) — остальные тоннажи (3/5/8/10/12/15) в прайсе не встречаются
# вообще. Подставить сюда 25 600 только для 7т сломало бы лестницу (7т стал бы
# дороже 8т) — оставлено как есть до отдельного уточнения у Аркона по остальным
# классам манипуляторов.
