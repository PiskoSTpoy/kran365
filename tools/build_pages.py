...
TASKS = [
  ...
  ("vyvoz-snega","Вывоз снега","вывоза снега",
   ...
   "погрузчик + самосвалы 20 м³", 10900,
  ...
  ("uborka-snega-mtz","Уборка снега трактором МТЗ","уборки снега трактором МТЗ",
   ...
   "МТЗ-82 с дорожной щёткой", 15000,
...
def build():
    ...
    page("uslugi/index.html", seo_title("Услуги спецтехники", "в Москве",
         ...
         crumbs, hero("Услуги", "Услуги спецтехники под вашу задачу",
                      ...
                      # манипулятором 7–8 т.
                      "Не нужно разбираться, какой кран заказать — опишите задачу, подберём технику и назовём точную цену. Автокраны 25–50 тонн и манипуляторы 7–8 тонн, работаем по Москве и всей области круглосуточно.", 16300),
