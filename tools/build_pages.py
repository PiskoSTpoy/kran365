...
<symbol id="i-mark" viewBox="0 0 32 32"><path d="M7 25V9h2v16H7z" fill="currentColor"/><path d="m9 12 12 1-12 4V12z" fill="currentColor"/><path d="M6 25h18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></symbol>
</svg>'''

NAV = '''<header class="nav" id="nav">
  <a class="brand" href="/" aria-label="КРАН365 — на главную">
    <span class="brand__mark"><svg><use href="#i-mark"/></svg></span><span>КРАН<b>365</b></span>
  </a>
