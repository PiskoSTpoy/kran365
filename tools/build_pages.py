  ...
  <div class="wrap">
    <div class="footer__top">
      <div>
        ...
        <p class="footer__desc">Аренда кранов и спецтехники в Москве и области. Свой парк, операторы в стоимости, подача в день заявки.</p>
...
TRUST = '''<div class="trust"><div class="wrap trust__row">
  <span class="trust__item"><svg><use href="#i-crane"/></svg> Свой парк — без посредников</span>
...
TYPES = [
  dict(slug="avtokrany", name="Автокраны", one="автокрана", price=16300,
       ...
       lead="Автокраны грузоподъёмностью от 16 до 500 тонн со стрелой до 96 метров. Свой парк, опытные крановщики в стоимости смены, подача по Москве и области в день заявки."),
...
def build():
    ...
    for t in TYPES:
        ...
        desc = "Аренда %s в Москве и МО: %s. Свой парк, оператор в стоимости, подача в день заявки, договор и ЭДО. Цена %s/смена. Звоните %s." % (
    ...
    for slug, name, txt in MARKI:
        ...
        page("avtokrany/marki/%s/index.html" % slug, "%s в Москве — цена от 16 300 ₽ | КРАН365" % h1,
             "Аренда автокрана %s в Москве и области. Свой парк, оператор в стоимости смены, подача в день заявки, договор и ЭДО. Звоните %s." % (name, PHONE_DISP),
    ...
    for slug, name, rod, lead, tech, pr, faqs in TASKS:
        ...
        page("uslugi/%s/index.html" % slug, "%s — цена %s | КРАН365" % (name, money(pr).lower()),
             "%s в Москве и МО. %s Свой парк, оператор в стоимости, подача в день заявки. Звоните %s." % (name, lead[:90].rsplit(" ",1)[0]+".", PHONE_DISP),
    ...
    for slug, prep, nom, route, neigh, spec in GEO:
        ...
        desc = "Аренда спецтехники в %s: %s. Автокраны, автовышки, манипуляторы, самосвалы. Свой парк, оператор в стоимости, подача в день заявки. %s" % (prep, route, PHONE_DISP)
        lead = ("Подаём автокраны, автовышки, манипуляторы, экскаваторы и самосвалы на объекты в %s. Направление — %s. "
                "Свой парк и опытные операторы, подача в день заявки, работа по договору и ЭДО.") % (prep, route)
        faqs = [
        ...
        prose = ('<p>%s</p><h2>Специфика работы в %s</h2><p>%s</p>'
                 ...
                 '<h2>Почему КРАН365</h2><ul><li>Свой парк — работаем без посредников и наценок</li><li>Подача в день заявки, приём заявок 24/7</li><li>Оператор и топливо в стоимости смены</li><li>Договор, счёт, ЭДО для юрлиц</li></ul>'
    ...
    for slug, prep, nom, route, neigh, spec in GEO_RF:
        ...
        faqs = [
            ...
            ("У вас свой парк в %s?" % prep, "Собственный парк КРАН365 базируется в Москве. В %s мы организуем аренду через проверенную партнёрскую сеть: подбираем технику под задачу и фиксируем условия договором." % prep),
